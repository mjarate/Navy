...
Navy_Wave_1 =
{
	...
	[UNIT_TEMPLATE,"B_Heli_Transport_03_unarmed_F",8,_spawn_trigger,heli_insert_item,cleanup_item,attack_item] spawn Navy_RunHeliInsert;
};
...
Navy_RunMission =
{
	...
	DEBUG
	{
		[_spawn_trigger] call Navy_Debug_SpawnZoneMarker;
	};
